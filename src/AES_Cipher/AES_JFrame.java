 ...
 * @author Mahmoud Esmat
 */
public class AES_JFrame extends javax.swing.JFrame {

    JFileChooser fileChooser = new JFileChooser(new File("test files/key.txt"));
    ...
    private void initComponents() {
        ...
        jta1.setRows(5);
        jta1.setText("You Must Generate Words Before Encryption & Decryption.");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jtf2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE))
        ...
        jtf7.setText("Plaintext_temp.txt");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jtf8)
                    .addComponent(jtf7, javax.swing.GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton22, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2))), "Key Expansion", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 15))); // NOI18N
        ...
        jLabel14.setText("Words File:");

        jtf13.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jtf13.setText("key_2.txt");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jtf13)
                    .addComponent(jtf14, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton30ActionPerformed
        ...
        File f = new File("test files/" + jtf13.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton29ActionPerformed
        // TODO add your handling code here:
        File f = new File("test files/" + jtf14.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        // TODO add your handling code here:
        File keyFile = new File("test files/" + jtf13.getText());
        File wordsFile = new File("test files/" + jtf14.getText());
        try {
            start_time = System.currentTimeMillis();
            KeyExpansion.KeyExpansion(keyFile, wordsFile);
            end_time = System.currentTimeMillis();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(Level.SEVERE, null, ex);
        }

        jta1.append("\nKey expansion operation is Done. Taken Time = " + (end_time - start_time) + " Milliseconds");

        try {
            java.awt.Desktop.getDesktop().open(wordsFile);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
                    Level.SEVERE, null, ex);
        }
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        // TODO add your handling code here:
        File f = new File("test files/" + jtf3.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        // TODO add your handling code here:
        File f = new File("test files/" + jtf2.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        File wordsFile = new File("test files/" + jtf14.getText());
        File ciphertext_file = new File("test files/" + jtf2.getText());
        File deciphertext_file = new File("test files/" + jtf3.getText());
        try {
            start_time = System.currentTimeMillis();
            AESDecryption.AESDecryption_main(wordsFile, ciphertext_file, deciphertext_file);
            end_time = System.currentTimeMillis();
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(Level.SEVERE, null, ex);
        }

        jta1.append("\nDecryption operation is Done. Taken Time = " + (end_time - start_time) + " Milliseconds");
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        // TODO add your handling code here:
        File f = new File("test files/" + jtf7.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        // TODO add your handling code here:
        File f = new File("test files/" + jtf8.getText());
        try {
            java.awt.Desktop.getDesktop().open(f);
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        AESEncryption.counter = 0;
        File wordsFile = new File("test files/" + jtf14.getText());
        File plaintext_file = new File("test files/" + jtf7.getText());
        File ciphertext_file = new File("test files/" + jtf8.getText());
        try {
            start_time = System.currentTimeMillis();
            AESEncryption.AESEncryption_main(wordsFile, plaintext_file, ciphertext_file);
            end_time = System.currentTimeMillis();
        } catch (IOException ex) {
            Logger.getLogger(AES_JFrame.class.getName()).log(Level.SEVERE, null, ex);
        }

        jta1.append("\nEncryption operation is Done. Taken Time = " + (end_time - start_time) + " Milliseconds");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AES_JFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                AES_JFrame myFrame = new AES_JFrame();
